...
2. Reemplaza las variables `produrl` y `dealerurl` usando las URLs de Code Engine obtenidas en el **Paso 3**.
   _Asegúrate de dejar una barra final `/` en las rutas_.
...
- **Screenshot 6 (2 pts):** Tras abrir la URL, toma captura cerciorándote de que el primer dropdown de _Products_ tiene opciones en la lista.
